 ...
 * 
 * @author frederic goldengate.ftp.core.file.filesystem FilesystemBasedFtpDir
 * 
 */
public abstract class FilesystemBasedFtpDir extends FtpDir {
    ...
    private static final FtpInternalLogger logger = FtpInternalLoggerFactory
            .getLogger(FilesystemBasedFtpDir.class);
    ...
    public static void initJdkDependent(
            FilesystemBasedFtpDirJdkAbstract filesystemBasedFtpDirJdkChoice) {
    ...
    public String validatePath(String path) throws FtpCommandAbstractException {
        ...
        FilesystemBasedFtpAuth ftpAuth = ((FilesystemBasedFtpAuth) this
                .getFtpSession().getFtpAuth());
    ...
    protected List<String> wildcardFiles(String pathWithWildcard)
        ...
        while (i < subdirs.size()) {
            ...
            FileFilter fileFilter = FilesystemBasedFtpCommonsIo
        ...
        for (File file: basedPaths) {
            String relativePath = ftpAuth.getRelativePath(normalizePath(file
                    .getAbsolutePath()));
     ...
     */
    @Override
    public boolean changeParentDirectory() throws FtpCommandAbstractException {
    ...
    protected String lsInfo(File file) {
        // Unix File type,permissions,hard link(?),owner(?),group(?),size,date
        // and filename
    ...
    public FtpFile setUniqueFile() throws FtpCommandAbstractException {
        ...
        File file = null;
        try {
            file = File.createTempFile(this.getFtpSession().getFtpAuth()
                    .getUser(), ".stou", this.getFileFromPath(this.currentDir));
        } catch (IOException e) {
