 ...
 * FilesystemBasedFtpAuth.java goldengate.ftp.core.auth.filesystem GoldenGateFtp
 * frederic
 */
...
/**
 * Ftp Authentification implementation with a Mount point for the global filesystem of ftp users.
 * Business root directory is /user/account or /user.
 * @author frederic
 * goldengate.ftp.core.auth.filesystem FilesystemBasedFtpAuth
 * 
 */
public abstract class FilesystemBasedFtpAuth extends FtpAuth {
	...
	public String getAbsolutePath(String path) {
		...
		return this.getFtpSession().getConfiguration().getBaseDirectory()+FtpDir.SEPARATOR+path;
	}
	/**
	...
	public String getRelativePath(String file) {
		...
		return file.replaceFirst(FilesystemBasedFtpDir.normalizePath(this.getFtpSession().getConfiguration().getBaseDirectory()), "");
	}
	/* (non-Javadoc)
	 * @see goldengate.ftp.core.auth.FtpAuth#isBusinessPathValid(java.lang.String)
	 */
	@Override
