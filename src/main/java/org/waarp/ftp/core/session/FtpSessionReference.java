...
/**
 * Class that allows to retrieve a session when a connection occurs on the Data network based on the
 * {@link InetAddress} of the remote client and the {@link InetSocketAddress} of the server for
