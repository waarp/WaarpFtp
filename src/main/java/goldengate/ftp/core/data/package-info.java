 ...
 * connection is ready. Then the FtpDataAsyncConn is also informed of this
 * status.
 * <li>The transfer is initiated</li> by calling setNewFtpTransfer method of the
 * FtpTransferControl object. This starts a new thread (FtpTransferExecutor) to
 ...
 * when it is over, it informs back the FtpTransferControl the transfer is
