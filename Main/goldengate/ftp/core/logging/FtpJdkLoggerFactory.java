 ...
 */
public class FtpJdkLoggerFactory extends JdkLoggerFactory {
	/**
	 * 
	 * @param level
	 */
	public FtpJdkLoggerFactory(Level level) {
		super();
		
		Logger logger = (Logger) Logger.getLogger(Logger.GLOBAL_LOGGER_NAME);
    ...
    public InternalLogger newInstance(String name) {
        ...
        return new FtpJdkLogger(logger, name);
    }
}
