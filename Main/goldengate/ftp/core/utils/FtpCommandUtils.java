...
public class FtpCommandUtils {
	/**
	 * Reinitialize the authentification to the connection step
	 * @param session
	 */
	 ...
	 * @throws Reply426Exception if the connection was opened before but shouldn't
	 */
	public static void openDataConnection(FtpSession session) throws Reply425Exception {
