/**
 * Frederic Bregier LGPL 18 janv. 09 FtpCommandAbstractException.java
 ...
 * 
 * @author frederic goldengate.ftp.core.command.exception
 *         FtpCommandAbstractException
 * 
 */
...
public abstract class FtpCommandAbstractException extends Exception {
    ...
    public String toString() {
        return "Code: " + this.code.name() + " Mesg: " +
                (this.message != null? this.message : "no specific message");
    }
