/**
 * Frederic Bregier LGPL 10 janv. 09 FtpReplyCode.java
 ...
 * 
 * @author frederic goldengate.ftp.core.command FtpReplyCode
 * 
 */
public enum FtpReplyCode {
    ...
    private FtpReplyCode(int code) {
        this.code = code;
        this.mesg = this.name().substring(6).replace('_', ' ') +
                FtpInternalConfiguration.CRLF;
    }
