 ...
 * MODE command
 * 
 * @author frederic goldengate.ftp.core.command.parameter MODE
 * 
 */
public class MODE extends AbstractCommand {
    ...
    public void exec() throws Reply501Exception, Reply504Exception {
        ...
        if (!this.hasArg()) {
            // Default
            this.getFtpSession().getDataConn().setMode(
        ...
        try {
            transferMode = FtpArgumentCode.getTransferMode(this.getArg()
                    .charAt(0));
