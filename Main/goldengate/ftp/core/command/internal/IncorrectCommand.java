 ...
 * Incorrect command
 * @author frederic
 * goldengate.ftp.core.command IncorrectCommand (Bad Sequence)
 * 
 */
public class IncorrectCommand extends AbstractCommand {
	...
	@Override
	public void exec() {
		this.getFtpSession().setReplyCode(FtpReplyCode.REPLY_503_BAD_SEQUENCE_OF_COMMANDS, 
				"Bas sequence of commands: "+this.getCommand()
				+" following "+this.getFtpSession().getPreviousCommand().getCommand());
