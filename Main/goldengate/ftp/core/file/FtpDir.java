...
/**
 * Base of Ftp Dir where only String are considered (no File since it can be
...
public abstract class FtpDir {
    ...
    /**
     * Init FtpFile after authentication is done
     * 
     */
     ...
     * @throws FtpCommandAbstractException
     */
    protected abstract FtpFile newFtpFile(String path, boolean append)
            throws FtpCommandAbstractException;
    ...
    /**
     * Set a new unique path as the current File from the current Directory
     * (STOU)
     * 
     * @return the Ftp File if it is correctly initiate
     * @throws FtpCommandAbstractException
     ...
     * @throws FtpCommandAbstractException
     */
    public abstract byte[] getMD5(String path)
            throws FtpCommandAbstractException;
     ...
     * @throws FtpCommandAbstractException
     */
    public abstract byte[] getSHA1(String path)
            throws FtpCommandAbstractException;
