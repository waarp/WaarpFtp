 ...
 * Note that if necessary, according to the implementation of {@link FtpDir} and {@link FtpFile},
 * one could want to implement a way to store or retrieve Marker from/to the client specification.
 * 
 * @author fbregier
 *
 */
public abstract class FtpRestart {
	 ...
	 */
	public abstract boolean restartMarker(String marker) throws FtpCommandAbstractException;
	// FIXME Additionaly the implementation should implement a way to get the values 
}
