...
/**
 * Class that implements Opts command for MLSx operations. 
...
public class FtpOptsMLSx {
	 ...
	 * @param optsCharset
	 */
	public FtpOptsMLSx(byte optsSize, byte optsModify, byte optsType, byte optsPerm, byte optsCreate, byte optsUnique, byte optsLang, byte optsMediaType, byte optsCharset) {
