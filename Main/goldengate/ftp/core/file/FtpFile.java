/**
 * Frederic Bregier LGPL 31 janv. 09 FtpFile.java goldengate.ftp.core.file
...
/**
 * Base of Ftp File where only String are considered (no File since it can be
 * something else than a file).
 * 
 * @author frederic goldengate.ftp.core.file FtpFile
 * 
 */
public abstract class FtpFile {
    ...
    /**
     * FtpDir associated with this file at creation. It is not necessary the
    ...
    /**
     * Ask to store the current File. This command returns quickly since it does
     * not store really. It prepares the connection and make a temporary answer.
     * 
    ...
    /**
     * Ask to retrieve the current File. This command returns quickly since it
     * does not retrieve really. It prepares the connection.
     * 
     * @return True if everything is ready
     * @throws FtpCommandAbstractException
     */
    ...
    /**
     * Restart from a Marker for the current File if any. This function is to be
     * called at the beginning of every transfer so in store and retrieve
     * method.
     * 
     * @param restart
     ...
     */
    protected abstract boolean restartMarker(FtpRestart restart)
            throws FtpCommandAbstractException;
     ...
     */
    protected abstract void writeRecordFtpDataBlock(FtpDataBlock dataBlock)
            throws FtpFileEndOfTransferException, FtpFileTransferException;
     ...
     * @throws FtpFileTransferException
     */
    protected abstract FtpDataBlock readRecordFtpDataBlock()
            throws FtpFileEndOfTransferException, FtpFileTransferException;
     ...
     * @throws FtpFileTransferException
     */
    protected abstract void writeFileFtpDataBlock(FtpDataBlock dataBlock)
            throws FtpFileEndOfTransferException, FtpFileTransferException;
     ...
     * @throws FtpFileTransferException
     */
    protected abstract FtpDataBlock readFileFtpDataBlock()
            throws FtpFileEndOfTransferException, FtpFileTransferException;

    /**
     * Function called by the DataNetworkHandler when it receives one
     * FtpDataBlock (Store like command)
     * 
     * @param dataBlock
     * @throws FtpFileTransferException
     * @throws FtpFileEndOfTransferException
     */
    public void receiveDataBlock(FtpDataBlock dataBlock)
            throws FtpFileEndOfTransferException, FtpFileTransferException {
    ...
    public void trueRetrieve() {
        ...
        try {
            ...
            Channel channel = this.session.getDataConn()
