...
/**
 * Third CODEC :<br>
 * - encode/decode : takes {@link FtpDataBlock} and transforms it to a
 * {@link FtpDataBlock}<br>
...
public class FtpDataStructureCodec extends SimpleChannelHandler {
    ...
    public void writeRequested(ChannelHandlerContext arg0, MessageEvent arg1)
        ...
        // Type unimplemented
        throw new FtpInvalidArgumentException("Structure unimplemented in " +
                this.getClass().getName() + " codec " + this.structure.name());
    }
