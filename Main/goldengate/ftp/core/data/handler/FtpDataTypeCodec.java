...
/**
 * Second CODEC :<br>
 * - encode/decode : takes a {@link FtpDataBlock} and trsnforms it to a new {@link FtpDataBlock} according to the types<br>
...
public class FtpDataTypeCodec extends SimpleChannelHandler {
    ...
    public void messageReceived(
		...
		if ((this.type == TransferType.ASCII) || (this.type == TransferType.EBCDIC)) {
		...
		// Type unimplemented
		throw new FtpInvalidArgumentException("Type unimplemented in "+this.getClass().getName()+" codec "+this.type.name());
    }
	/**
	 * 
	 * @param channelBuffer
	 * @throws Exception
	 */
	protected ChannelBuffer decode(ChannelBuffer channelBuffer) throws Exception {
		return ChannelBuffers.copiedBuffer(channelBuffer.toString(this.type.charsetName), charsetName);
	}
	 ...
	 * @throws Exception
	 */
	protected ChannelBuffer encode(ChannelBuffer channelBuffer) throws Exception {
