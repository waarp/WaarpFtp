 ...
 * FtpDataPipelineFactory.java goldengate.ftp.core.control GoldenGateFtp
 * frederic
 */
 ...
 * @author frederic
 * goldengate.ftp.core.control FtpDataPipelineFactory
 * 
 */
public class FtpDataPipelineFactory implements ChannelPipelineFactory {
	...
	private static FtpInternalLogger logger = 
		FtpInternalLoggerFactory.getLogger(FtpDataPipelineFactory.class);
	/**
	 * Mode Codec
	 */
	 ...
	 * @param configuration 
	 */
	public FtpDataPipelineFactory(Class dataBusinessHandler, FtpConfiguration configuration) {
	...
	public ChannelPipeline getPipeline() throws Exception {
		...
		DataBusinessHandler newbusiness = (DataBusinessHandler) dataBusinessHandler.newInstance();
		DataNetworkHandler newNetworkHandler = new DataNetworkHandler(configuration, newbusiness);
