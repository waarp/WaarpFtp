/**
 * Frederic Bregier LGPL 10 janv. 09 NetworkHandler.java
 ...
 * 
 * @author frederic goldengate.ftp.core.control NetworkHandler
 * 
 */
...
public class NetworkHandler extends SimpleChannelHandler {
    ...
    public void channelClosed(ChannelHandlerContext ctx, ChannelStateEvent e)
        ...
        int limit = 100;
        while (this.session.getDataConn().getFtpTransferControl()
    ...
    public void channelConnected(ChannelHandlerContext ctx, ChannelStateEvent e) {
        ...
        FtpChannelUtils.addCommandChannel(channel, this.session
                .getConfiguration());
        if (isStillAlive()) {
            // Make the first execution ready
            AbstractCommand command = new ConnectionCommand(this
                    .getFtpSession());
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, ExceptionEvent e) {
        ...
        if (e1 instanceof ConnectException) {
            ...
            logger.warn("Unexpected exception from downstream" +
                    " Ref Channel: " + e.getChannel().toString(),
                    e1);
        }
        this.session.setExitErrorCode("Internal error: disconnect");
        this.businessHandler.exceptionLocalCaught(e);
    ...
    public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) {
        if (isStillAlive()) {
            ...
            AbstractCommand command = FtpCommandCode.getFromLine(this
                    .getFtpSession(), message);
            // Default message
            this.session
                    .setReplyCode(FtpReplyCode.REPLY_200_COMMAND_OKAY, null);
            ...
            if (this.session.getCurrentCommand().isNextCommandValid(command)) {
                ...
                command.setArgs(this.getFtpSession(), message, null,
    ...
    private void messageRunAnswer() {
        try {
            ...
            logger
                    .info("Run {}", this.session.getCurrentCommand()
                            .getCommand());
