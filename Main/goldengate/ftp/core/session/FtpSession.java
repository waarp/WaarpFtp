 ...
 * FtpSession.java goldengate.ftp.core.session GoldenGateFtp
 * frederic
 */
...
/**
 * Main class that stores any information that must be accessible from
 * anywhere during the connection of one user.
 * @author frederic
...
public class FtpSession {
	 ...
	 * sequence of commands or unknown command)
	 *
	 */
	...
	public void setExitErrorCode(String answer) {
		this.setReplyCode(FtpReplyCode.REPLY_421_SERVICE_NOT_AVAILABLE_CLOSING_CONTROL_CONNECTION, answer);
	}
	/**
	...
	public void setExitNormalCode(String answer) {
		this.setReplyCode(FtpReplyCode.REPLY_221_CLOSING_CONTROL_CONNECTION, answer);
	}
	/**
	...
	public String toString() {
		...
		if (this.currentCommand != null) {
			mesg += "CMD: "+this.currentCommand.getCommand()+" "+this.currentCommand.getArg()+" ";
		}
		if (this.replyCode != null) {
			mesg += "Reply: "+(this.answer != null ? this.answer:this.replyCode.getMesg())+" ";
		}
		if (this.dataConn != null) {
